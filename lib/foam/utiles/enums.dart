...
import 'package:janssenfoamweb/main.dart';
  ...
  ActionModel get add {
    switch (this) {
      case BlockAction.create_block:
        return ActionModel(
            action: "create_block", who: usermame, when: DateTime.now());
      case BlockAction.consume_block:
        return ActionModel(
            action: "consume_block", who: usermame, when: DateTime.now());
      case BlockAction.unconsume_block:
        return ActionModel(
            action: "unconsume_block", who: usermame, when: DateTime.now());
      ...
      case BlockAction.cut_block_on_H:
        return ActionModel(
            action: "cut_block_on_H", who: usermame, when: DateTime.now());
      case BlockAction.archive_block:
        return ActionModel(
            action: "archive_block", who: usermame, when: DateTime.now());
      case BlockAction.UN_cut_block_on_H:
        return ActionModel(
            action: "UN_cut_block_on_H", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      ...
      case finalProdcutAction.out_order:
        return ActionModel(
            action: "out_order", who: usermame, when: DateTime.now());
      ...
      case finalProdcutAction.createInvoice:
        return ActionModel(
            action: "createInvoice", who: usermame, when: DateTime.now());
  ...
  ActionModel get add {
    switch (this) {
      case FractionActon.creat_fraction:
        return ActionModel(
            action: "creat_fraction", who: usermame, when: DateTime.now());
      case FractionActon.archive_fraction:
        return ActionModel(
            action: "archive_fraction", who: usermame, when: DateTime.now());
  ...
  ActionModel get add {
    switch (this) {
      case InvoiceAction.creat_invoice:
        return ActionModel(
            action: "creat_invoice", who: usermame, when: DateTime.now());
      case InvoiceAction.archive_invoice:
        return ActionModel(
            action: "archive_invoice", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      ...
      case StockCheckAction.archive_StockCheck:
        return ActionModel(
            action: "archive_StockCheck", who: usermame, when: DateTime.now());
      case StockCheckAction.refrechDone:
        return ActionModel(
            action: "refrechDone", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      case PurcheAction.creat_new_Purche:
        return ActionModel(
            action: "creat_new_Purche", who: usermame, when: DateTime.now());
      case PurcheAction.archive_Purche:
        return ActionModel(
            action: "archive_Purche", who: usermame, when: DateTime.now());
      ...
      case PurcheAction.offer_chosen:
        return ActionModel(
            action: "offer_chosen", who: usermame, when: DateTime.now());
      case PurcheAction.add_purche_offer:
        return ActionModel(
            action: "add_purche_offerm", who: usermame, when: DateTime.now());
  ...
  ActionModel get add {
    switch (this) {
      ...
      case VeiwingAction.openHomePage:
        return ActionModel(
            action: "فتح الصفحة الرئيسيه", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      case customerAction.create_new_customer:
        return ActionModel(
            action: "create_new_customer", who: usermame, when: DateTime.now());
      case customerAction.archive_customer:
        return ActionModel(
            action: "archive_customer", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      ...
      case subfractionAction.archive_subfraction:
        return ActionModel(
            action: "archive_subfraction", who: usermame, when: DateTime.now());
  ...
  ActionModel get add {
    switch (this) {
      case OrderAction.order_edit:
        return ActionModel(
            action: "order_edit", who: usermame, when: DateTime.now());
      case OrderAction.create_order:
        return ActionModel(
            action: "create_order", who: usermame, when: DateTime.now());
      case OrderAction.Archive_order:
        return ActionModel(
            action: "Archive_order", who: usermame, when: DateTime.now());
      ...
      case OrderAction.order_colosed:
        return ActionModel(
            action: "order_colosed", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      case Appactions.open_Home_page:
        return ActionModel(
            action: "open_Home_page", who: usermame, when: DateTime.now());
      ...
      case Appactions.open_1_addToBlock:
        return ActionModel(
            action: "open_1_addToBlock", who: usermame, when: DateTime.now());
  ...
  ActionModel get add {
    switch (this) {
      case UserAction.creat_user:
        return ActionModel(
            action: "creat_user", who: usermame, when: DateTime.now());
      case UserAction.archive_user:
        return ActionModel(
            action: "archive_user", who: usermame, when: DateTime.now());
    }
  }
  ...
  ActionModel get add {
    switch (this) {
      case WhigtTecketAction.create_fristWhight:
        return ActionModel(
            action: "create_fristWhight", who: usermame, when: DateTime.now());
      case WhigtTecketAction.create_secondWhigt:
        return ActionModel(
            action: "create_secondWhigt", who: usermame, when: DateTime.now());
      case WhigtTecketAction.archive_tecket:
        return ActionModel(
            action: "archive_tecket", who: usermame, when: DateTime.now());
      case WhigtTecketAction.create_newTicket:
        return ActionModel(
            action: "create_newTicket", who: usermame, when: DateTime.now());
    }
  }
